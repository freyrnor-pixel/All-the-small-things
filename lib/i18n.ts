...
const en = {
  ...
  notificationsSub: 'We can send you gentle reminders so you never have to remember everything yourself.',
  weeklyRemindersOnboarding: 'Weekly reminders',
  weeklyRemindersHint: 'Plan your week',
...
const no: typeof en = {
  ...
  notificationsSub: 'Vi kan sende deg varme påminnelser slik at du aldri trenger å huske alt selv.',
  weeklyRemindersOnboarding: 'Ukentlige påminnelser',
  weeklyRemindersHint: 'Planlegg uken din',
  timePlaceholder: '08:00',
