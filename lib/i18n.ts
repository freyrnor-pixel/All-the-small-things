...
const en = {
  ...
  ok: 'OK',
  // Home screen
  tasksToday: "Today's plans",
  essentialTasksToday: '⭐ Essential plans today',
  noTasks: 'No plans today — enjoy your day 🌿',
  noEssentialTasks: 'No essential plans today — great!',
  addNew: '+ New',
  essentialsHidden: (n: number) => `+ ${n} regular plan${n !== 1 ? 's' : ''} hidden →`,
  ...
  cover: {
    tasksToday: 'Today',
    taskCount: (n: number) => `${n} plan${n !== 1 ? 's' : ''}`,
    noTasks: 'All done!',
    quickAdd: '+ Add',
    habitsToday: 'Habits',
  ...
  hints: {
    home: {
      text: "Your daily overview. The most important plans are at the top — tap ⭐ to focus on essentials only.",
    ...
    focus: {
      text: 'One plan at a time. Tap Done when you finish, or Skip to move to the next one.',
...
const no: typeof en = {
  ...
  ok: 'OK',
  tasksToday: 'Planer i dag',
  essentialTasksToday: '⭐ Viktige planer i dag',
  noTasks: 'Ingen planer i dag! Nyt dagen 🌿',
  noEssentialTasks: 'Ingen viktige planer i dag — bra!',
  addNew: '+ Ny',
  essentialsHidden: (n: number) => `+ ${n} vanlige planer skjult →`,
  ...
  cover: {
    tasksToday: 'I dag',
    taskCount: (n: number) => `${n} plan${n !== 1 ? 'er' : ''}`,
    noTasks: 'Alt klart!',
    quickAdd: '+ Legg til',
    habitsToday: 'Vaner',
  ...
  hints: {
    home: {
      text: 'Din daglige oversikt. De viktigste planene er øverst — trykk ⭐ for å fokusere kun på viktige.',
    ...
    focus: {
      text: 'Én plan om gangen. Trykk Ferdig når du er klar, eller Hopp over for å gå til neste.',
