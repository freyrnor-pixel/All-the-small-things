...
const en = {
  ...
  features: [
    { icon: '✅', text: "Stay on top of today's plans — without remembering everything yourself" },
  ...
  hints: {
    ...
    taskForm: {
      text: 'Fill in at minimum a title and a date for your plan. Time and recurrence are optional — keep it simple.',
...
const no: typeof en = {
  ...
  features: [
    { icon: '✅', text: 'Hold styr på dagens planer — uten å huske alt selv' },
  ...
  hints: {
    ...
    taskForm: {
      text: 'Fyll inn minst tittel og dato for planen. Tidspunkt og gjentagelse er valgfritt — hold det enkelt.',
