...
const en = {
  ...
  sectionBubbleMaterial: 'Bubble finish',
  ...
  features: [
    { icon: 'checkbox-outline', text: "Stay on top of today's tasks — without remembering everything yourself" },
  ...
  monthlyPickerConfirm: (n: number) => `Add ${n} to weekly list`,
  noMonthlyItems: 'No items in monthly list yet',
  ...
  materialNames: { glass: 'Glass', metal: 'Metal', rock: 'Rock', paper: 'Paper' },
  ...
  addFreelyTab: 'Add freely',
  addFromMonthlyTab: 'From monthly',
  ...
  config: {
    ...
    desc: {
      ...
      material: 'Choose how the menu bubbles look and feel.',
...
const no: typeof en = {
  ...
  sectionBubbleMaterial: 'Bobleoverflate',
  ...
  features: [
    { icon: 'checkbox-outline', text: 'Hold styr på dagens oppgaver — uten å huske alt selv' },
  ...
  monthlyPickerConfirm: (n: number) => `Legg til ${n} i ukeliste`,
  noMonthlyItems: 'Ingen varer i månedslisten ennå',
  ...
  config: {
    ...
    desc: {
      ...
      material: 'Velg hvordan menyboblene ser og føles ut.',
  ...
  materialNames: { glass: 'Glass', metal: 'Metall', rock: 'Stein', paper: 'Papir' },
  ...
  addFreelyTab: 'Legg til fritt',
  addFromMonthlyTab: 'Fra månedsliste',
