...
const en = {
  ...
  catalogResetBanner: (day: string) => `Reference catalog for staple items. Resets on the ${day}th each month.`,
  ...
  // --- Shopping list redesign (legacy keys, mostly superseded above) ---
  ...
  config: {
    ...
    desc: {
      ...
      material: 'Choose the surface finish for bubbles, cards and backgrounds.',
...
const no: typeof en = {
  ...
  catalogResetBanner: (day: string) => `Referansekatalog for faste varer. Nullstilles den ${day}. hver måned.`,
  ...
  config: {
    ...
    desc: {
      ...
      material: 'Velg overflaten for bobler, kort og bakgrunner.',
