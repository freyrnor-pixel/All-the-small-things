...
const en = {
  ...
  dateLabel: 'Date',
  showFullMonth: 'Show full month',
  showWeekOnly: 'Show week only',
  timeLabel: 'Time',
  ...
  features: [
    ...
    { icon: '💚', text: 'Health journal' },
    { icon: '💼', text: 'Personal / work mode' },
  ],
  ...
  shoppingOnboardingSub: 'One list per month for everything needed, split up into weekly shopping lists.',
...
const no: typeof en = {
  ...
  dateLabel: 'Dato',
  showFullMonth: 'Vis hele måneden',
  showWeekOnly: 'Vis bare uken',
  timeLabel: 'Tidspunkt',
  ...
  typeTimeBox: 'Tidsblokk (varighet)',
  ...
  features: [
    { icon: '✅', text: 'Gjøremålsliste' },
    { icon: '🛒', text: 'Handlelist' },
    { icon: '📦', text: 'Varebeholdning' },
    { icon: '💚', text: 'Helsedagbok' },
    { icon: '💼', text: 'Privat / jobb-modus' },
  ],
  ...
  shoppingOnboardingSub: 'Én liste per måned for alt som trengs, delt opp i ukentlige handlelister.',
