...
const en = {
  ...
  welcomeSub: 'Set it up once — let the app do the rest.',
  features: [
    { icon: 'checkbox-outline', text: 'To-do list' },
    { icon: 'cart-outline', text: 'Shopping' },
    { icon: 'cube-outline', text: 'Inventory management' },
    { icon: 'heart-outline', text: 'Health journal' },
    { icon: 'briefcase-outline', text: 'Personal & work mode' },
  ],
  whatsYourName: "What's your name?",
  nameHint: 'Only used to say hi — no data leaves your phone.',
  getStarted: 'Get started →',
  workModeOnboarding: 'Work mode',
  workModeOnboardingSub: 'Shows only work tasks so you can stay focused. Switch modes anytime from home.',
  ...
  appSwitchesItself: 'Switches automatically based on the clock',
  workHoursFormat: 'Work hours (HH:MM)',
  tipWorkMode: 'Tap "Switch mode" on home to switch back anytime.',
  shoppingOnboarding: 'Shopping list',
  shoppingOnboardingSub: 'Weekly list resets itself. Monthly list covers recurring essentials.',
  ...
  monthlyPaydayHint: 'Tip: pick your payday so items are ready when funds arrive.',
  notificationsOnboarding: 'Notifications',
  notificationsSub: 'A weekly shopping nudge, plus alerts when tasks start.',
  ...
  themeSub: 'Pick a colour theme — change it anytime.',
  finishBtn: "Let's go!",
  guidedTitle: 'How do you want to start?',
  guidedSub: 'Tips are always in Settings.',
  guidedBtn: 'Walk me through it',
  guidedDesc: 'Quick walkthrough of each feature',
  exploreBtn: 'Jump right in',
  exploreDesc: 'Tips are available in Settings',
  english: 'English',
  norwegian: 'Norwegian',
...
const no: typeof en = {
  ...
  welcomeHeading: 'UnFocus',
  welcomeSub: 'Sett den opp én gang — la appen gjøre resten.',
  features: [
    { icon: 'checkbox-outline', text: 'Gjøreliste' },
    { icon: 'cart-outline', text: 'Handling' },
    { icon: 'cube-outline', text: 'Lagerstyring' },
    { icon: 'heart-outline', text: 'Helsedagbok' },
    { icon: 'briefcase-outline', text: 'Privat og jobb-modus' },
  ],
  ...
  workModeOnboardingSub: 'Viser bare jobb-oppgaver for å holde fokus. Bytt modus når som helst fra hjemskjermen.',
  startWithWorkMode: 'Vil du også bruke appen til jobb?',
  canChangeAnytime: 'Du kan endre dette når som helst',
  autoActivateWorkHours: 'Aktiver automatisk i arbeidstiden',
  appSwitchesItself: 'Bytter automatisk basert på klokkeslett',
  workHoursFormat: 'Arbeidstid (HH:MM)',
  tipWorkMode: 'Trykk «Bytt modus» på hjemskjermen for å bytte tilbake når som helst.',
  shoppingOnboarding: 'Handleliste',
  shoppingOnboardingSub: 'Ukeslisten nullstilles selv. Månedslisten dekker faste varer.',
  ...
  monthlyPaydayHint: 'Tips: sett dette til lønningsdagen din — varene er klare når pengene kommer.',
  notificationsOnboarding: 'Varsler',
  notificationsSub: 'En ukentlig handlepåminnelse, pluss varsler når oppgaver starter.',
  ...
  themeSub: 'Velg et fargetema — du kan alltid endre det.',
  finishBtn: 'Kom i gang!',
  guidedTitle: 'Hvordan vil du starte?',
  guidedSub: 'Tips finner du alltid i innstillingene.',
  guidedBtn: 'Vis meg rundt',
  guidedDesc: 'Kort gjennomgang av hver funksjon',
  exploreBtn: 'Hopp rett inn',
  exploreDesc: 'Tips er tilgjengelige i innstillingene',
  english: 'English',
  norwegian: 'Norsk',
  ...
  onboarding: {
    privacy: {
      ...
      local: 'Alt forblir på denne enheten.',
      free: 'Gratis, alltid.',
      cta: 'Skjønner →',
    },
  },
