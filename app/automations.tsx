 ...
 *
 * Connections:
 *   Imports → components/AppModal, components/HintCard, components/ScreenBackground, components/ScreenHeader, components/Surface, constants/theme, lib/haptics, lib/i18n, lib/useAppTheme, store/useAutomationStore
