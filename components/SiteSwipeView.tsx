 ...
 *   Used by → app/index, app/plans, app/shopping, app/meals, app/health, app/scan, app/budget,
 *             app/shared, app/automations, app/habits, app/settings (wraps each screen's body)
